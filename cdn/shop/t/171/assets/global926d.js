...
Line 47:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 49:45 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 103:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 117:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 118:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 157:40 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 168:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 171:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 177:0 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 178:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
